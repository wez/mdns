use crate::dns_parser::rdata::opt::Record as Opt;
use crate::dns_parser::{Class, RData, ResourceRecord, Type};
use crate::dns_parser::{Error, Header, Name, Packet, QueryClass, QueryType, Question};
...
mod test {
    ...
    use crate::dns_parser::ResponseCode::NoError;
